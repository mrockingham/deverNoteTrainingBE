...
import {
  ...
  updateSandboxSessionSchema,
} from "../schemas/sandboxSessionSchemas.js";
...
export const updateSandboxSession = async (
  req: AuthRequest,
  res: Response
): Promise<void> => {
  try {
    ...
    const updatedSession = await prisma.sandboxSession.update({
      ...
      data: {
        ...
        ...(data.dependencies !== undefined
          ? {
              dependencies:
                data.dependencies as Prisma.InputJsonValue | undefined,
            }
          : {}),
...
export const getSandboxSessions = async (
  req: AuthRequest,
  res: Response
): Promise<void> => {
  try {
...
export const getSandboxSessionById = async (
  req: AuthRequest,
  res: Response
): Promise<void> => {
  try {
...
export const deleteSandboxSession = async (
  req: AuthRequest,
  res: Response
): Promise<void> => {
  try {
